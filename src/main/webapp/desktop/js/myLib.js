...
var myLib = {
	...
	// 获取对象类型名,["Array", "Boolean", "Date", "Number", "Object", "RegExp",
	...
	progressBar : function() {
		$(
				"<div id='myCover'></div><div id='loadimg'><span>正在加载,请稍等O(∩_∩)O哈！</span></div>")
				.appendTo('body');
		...
		$('#loadimg').css({
			'position' : 'absolute',
			'background' : 'url(themes/default/images/loading.gif) no-repeat center center',
			'z-index' : 10000,
			'width' : '110px',
			'height' : '64px',
			'left' : (w - 110) / 2,
