...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			var $NavMth = (Math.floor($AllMth/$Mth)==0)? 1:Math.floor($AllMth/$Mth); //opts.PagesNavMth; // 导航显示个数
			...
			//<cite class=\"FormNum\">直接到第<input type=\"text\" name=\"PageNum\" id=\"PageNum\">页</cite><a href=\"javascript:;\" class=\"PageNumOK\">确定</a>
			/*默认初始化显示*/
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span class=\"statistics\">共<b>"+$AllMth+"</b>条，共<b>"+PagesMth+"</b>页</span>";
